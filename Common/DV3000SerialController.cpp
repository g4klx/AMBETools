...
all AMBE+2
*/
const unsigned char DV3000_REQ_YSF_FEC[] = { DV3000_START_BYTE, 0x00U, 0x02U, DV3000_TYPE_CONTROL, DV3000_CONTROL_RATET, 59U };
const unsigned int DV3000_REQ_YSF_FEC_LEN = 6U;

const unsigned char DV3000_REQ_YSF_NOFEC[] = { DV3000_START_BYTE, 0x00U, 0x02U, DV3000_TYPE_CONTROL, DV3000_CONTROL_RATET, 41U };
